...
![매크로 (1)](https://user-images.githubusercontent.com/106823471/171931273-9b040fb5-2d80-40a8-a51f-b920e676426c.PNG)

1. 커맨드 모드(Esc)에서 'q'를 누르고 a~z 사이 문자로 단축키 설정하여 매크로 recording 시작하고, 삽입모드로 전환(밑 --recording 문구뜨면 시작)한다.


![q11](https://user-images.githubusercontent.com/106823471/171931010-f7cb3855-2010-44ef-ae43-9d8025a1d2e1.PNG)

2. 매크로 원하는 문자열을 입력한다.


![매크로 (4)](https://user-images.githubusercontent.com/106823471/171932399-a8074fac-46d6-4ac4-83bc-5ae45d16b366.PNG)

3. 커맨드 모드로 돌아와서 'q'를 누르고, 매크로 recording 완료한다.


![매크로 (3)](https://user-images.githubusercontent.com/106823471/171931699-10492779-7abd-48f0-83d4-52a50b02c75d.PNG)

4. @ + <저장한 매크로 문자(a)>으로 특정 문자에 저장한 매크로를 실행하면 매크로로 저장된 문자열이 입력된다.

**매크로 사용하기**
* 첫 번째 방법 : @ + <저장한 매크로 문자(a)>으로 특정 문자에 저장한 매크로를 실행하면 매크로로 저장된 문자열이 입력된다.
* 두 번째 방법 : 반복횟수 + @ + <저장한 매크로 문자(a)>으로 매크로 반복실행한다.
* 세 번째 방법 : @@를 누르면 제일 마지막에 수행한 매크로가 입력된다. (@q를 했다면 @@으로 재생되는 매크로는 q가 된다.)


**파일에 자주 사용하는 매크로 저장하는 방법**
1. :w, 현재 편집중인 내용을 저장한 후 ~/.vimrc 를 연다.(:e ~/.vimrc)

![21313213](https://user-images.githubusercontent.com/106823471/171934643-fd0fd629-a706-40ee-bdb6-6a8041ad4105.PNG)
...
![vimvim](https://user-images.githubusercontent.com/106823471/171936960-0336e9c4-7929-4388-85ba-e6cbfcc04793.PNG)

**Vimgolf에서의 매크로 활용**
* Start file -> End file 위해서는 ‘q + a’으로 반복작업 시작한 후, [a]의 앞에 [ (( ]를 입력하고, 문자열의 가장 끝에 [ )) ] 입력한 뒤 명령 모드로 전환하여 [&]를 제거한다. 그 다음 ‘q’로 레코딩 종료하여 4번째 줄의 맨 앞부분에 ‘@ + A’로 저장된 매크로를 실행하여 삽입한다.
